...
def register():
    ...
    Scene.repair_model_scope = EnumProperty(
        name=t('Scene.repair_model_scope.label'),
        description=t('Scene.repair_model_scope.desc'),
        items=[
            ("FULL", t('Scene.repair_model_scope.full.label'), t('Scene.repair_model_scope.full.desc')),
            ("SAFE", t('Scene.repair_model_scope.safe.label'), t('Scene.repair_model_scope.safe.desc')),
            ("ARMATURE", t('Scene.repair_model_scope.armature.label'), t('Scene.repair_model_scope.armature.desc')),
            ("WEIGHTS", t('Scene.repair_model_scope.weights.label'), t('Scene.repair_model_scope.weights.desc')),
            ("MATERIALS", t('Scene.repair_model_scope.materials.label'), t('Scene.repair_model_scope.materials.desc')),
            ("CLEANUP", t('Scene.repair_model_scope.cleanup.label'), t('Scene.repair_model_scope.cleanup.desc')),
            ("CUSTOM", t('Scene.repair_model_scope.custom.label'), t('Scene.repair_model_scope.custom.desc')),
        ],
        default="FULL"
    )

    Scene.repair_model_type = EnumProperty(
        name=t('Scene.repair_model_type.label'),
        description=t('Scene.repair_model_type.desc'),
        items=[
            ("AUTO", t('Scene.repair_model_type.auto.label'), t('Scene.repair_model_type.auto.desc')),
            ("MMD", t('Scene.repair_model_type.mmd.label'), t('Scene.repair_model_type.mmd.desc')),
            ("VRM", t('Scene.repair_model_type.vrm.label'), t('Scene.repair_model_type.vrm.desc')),
            ("SOURCE", t('Scene.repair_model_type.source.label'), t('Scene.repair_model_type.source.desc')),
            ("FBX_XPS", t('Scene.repair_model_type.fbx_xps.label'), t('Scene.repair_model_type.fbx_xps.desc')),
            ("GENERIC", t('Scene.repair_model_type.generic.label'), t('Scene.repair_model_type.generic.desc')),
        ],
        default="AUTO"
    )

    Scene.repair_preserve_ik = BoolProperty(
        name=t('Scene.repair_preserve_ik.label'),
        description=t('Scene.repair_preserve_ik.desc'),
        default=True
    )

    Scene.repair_preserve_fk = BoolProperty(
        name=t('Scene.repair_preserve_fk.label'),
        description=t('Scene.repair_preserve_fk.desc'),
        default=True
    )

    Scene.repair_preserve_constraints = BoolProperty(
        name=t('Scene.repair_preserve_constraints.label'),
        description=t('Scene.repair_preserve_constraints.desc'),
        default=True
    )

    Scene.repair_rename_bones = BoolProperty(
        name=t('Scene.repair_rename_bones.label'),
        description=t('Scene.repair_rename_bones.desc'),
        default=True
    )

    Scene.repair_weights = BoolProperty(
        name=t('Scene.repair_weights.label'),
        description=t('Scene.repair_weights.desc'),
        default=True
    )

    Scene.repair_hierarchy = BoolProperty(
        name=t('Scene.repair_hierarchy.label'),
        description=t('Scene.repair_hierarchy.desc'),
        default=True
    )

    Scene.repair_shapekeys = BoolProperty(
        name=t('Scene.repair_shapekeys.label'),
        description=t('Scene.repair_shapekeys.desc'),
        default=True
    )

    Scene.repair_transforms = BoolProperty(
        name=t('Scene.repair_transforms.label'),
        description=t('Scene.repair_transforms.desc'),
        default=True
    )

    Scene.repair_clean_objects = BoolProperty(
        name=t('Scene.repair_clean_objects.label'),
        description=t('Scene.repair_clean_objects.desc'),
        default=True
    )

    Scene.repair_uvs = BoolProperty(
        name=t('Scene.repair_uvs.label'),
        description=t('Scene.repair_uvs.desc'),
        default=True
    )

    Scene.repair_model_specific = BoolProperty(
        name=t('Scene.repair_model_specific.label'),
        description=t('Scene.repair_model_specific.desc'),
        default=True
    )
