...
def set_bone_layer(edit_bone, layer_index):
    if hasattr(edit_bone, 'layers'):
        edit_bone.layers = [x == layer_index for x in range(len(edit_bone.layers))]
